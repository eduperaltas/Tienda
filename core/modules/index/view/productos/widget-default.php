...
<section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div style="background:#333;font-size:25px;color:white;padding:5px;">
                <?php 
                ...
                <div class="row">
                    ...
                    <?php 
                    $n =($_GET['pagina']-1)*$card_x_pagina; //cambiar para que funcione busqueda
                  ...
                  ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            ...
                            <center> <a href="index.php?view=producto&product_id=<?php echo $p->id; ?>"> <img
                                        src="<?php echo $img; ?>" class="card-img-top" alt="..."></center></a>
                            <br>
                            <h4 class="card-title"><?php echo $p->name; ?> </h4>
                            <h3 class="card-text"><?php echo $coin; ?> <?php echo number_format($p->price,2,".",","); ?>
                            </h3>
                            <?php 
                              $in_cart=false;
                            ...
                            <div class="card-footer">
                                ...
                                <a href="javascript:void()" class="btn btn-labeled  btn-warning tip"
                                    title="No disponible">
                                    <!-- aca pregunto si es que esa en existencia de eso depende la posibilidad de compra -->
                                    <span><i class="fa fa-shopping-cart"></i></span> No Disponible</a>
                                <br>

                                <?php elseif(!$in_cart):?>

                                <a href="index.php?action=addtocart&product_id=<?php echo $p->id; ?>&href=cat&pagina=<?php echo $_GET['pagina']?>" 
                                    class="btn btn-labeled  btn-primary tip" title="A&ntilde;adir al carrito">
                                    <span><i class="fa fa-shopping-cart"></i></span> Comprar</a> <!-- Podria mejorar si se queda en la pagina actual-->
                                <br>
                                <?php else:?>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <li class="page-item <?php echo $_GET['pagina']<=1 ?'disabled': '' ?>">
                            <a class="page-link"
                                href="index.php?view=productos&cat=<?php echo$_GET['cat']?>&pagina=<?php echo $_GET['pagina']-1 ?>"
                        ...
                        <li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active' : '' ?>">
                            <a class="page-link"
                                href="index.php?view=productos&cat=<?php echo$_GET['cat']?>&pagina=<?php echo $i+1?>">
                                <?php echo $i+1?>
                            </a>
                        </li>
                        ...
                        <li class="page-item <?php echo $_GET['pagina']>=$paginas ?'disabled': '' ?>">
                            <a class="page-link"
                                href="index.php?view=productos&cat=<?php echo$_GET['cat']?>&pagina=<?php echo $_GET['pagina']+1 ?>">Siguiente</a>
                        </li>
                    </ul>
                </nav>
