            ...
            <div class="panel-body ">
                <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <textarea class="form-control" id="inputPassword1" placeholder="Descripcion" rows="6"
                        ...
                        <div class="col-lg-5">
                            <div class="input-group" style="width:200px">
                                ...
                                <input type="text" class="form-control" placeholder="Precio"
                                    value="<?php echo $product->price; ?>" required name="price">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <label for="inputEmail1" class="col-lg-2 control-label">Video</label>
                        ...
                        <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="termina el elink" required name="video">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="is_public"
                                        <?php if($product->is_public){ echo "checked";} ?>> Es Visible
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="in_existence"
                                        <?php if($product->in_existence){ echo "checked";} ?>> En Existencia
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="is_featured"
                                        <?php if($product->is_featured){ echo "checked";} ?>> Producto destacado
                                </label>
                            </div>
                        </div>
 ...
 if(count($categories)>0):?>
                            <select name="unit_id" class="form-control">
                                ...
                                <option value="<?php echo $cat->id; ?>"
                                    <?php if($product->unit_id==$cat->id){ echo "selected";} ?>>
