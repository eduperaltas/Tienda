    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">STORE LITE <sup><small><span class="label label-primary">v2</span></small></sup> </a>
        </div>
...
?>
         <ul class="nav navbar-nav">
          ...
          <li><a href="index.php?view=products"><i class="fas fa-box"></i> Productos</a></li>
          <li><a href="index.php?view=sells"><i class="fa fa-shopping-cart"></i> Ventas</a></li>
          <li><a href="index.php?view=sellreport"><i class="fas fa-file"></i> Reportes</a></li>
